...
mvn install:install-file \
  -Dfile=target/dhgrid-component-1.0.0-delta.jar \
...
cp target/dhgrid-component-1.0.0-delta.jar demo/src/main/webapp/downloads/dhgrid-component-1.0.0-delta.jar
...
echo "   - Downloadable JAR       : http://localhost:8085/downloads/dhgrid-component-1.0.0-delta.jar"
echo "============================================================"
echo ""
